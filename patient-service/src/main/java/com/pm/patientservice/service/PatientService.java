...
public class PatientService {
    ...
    public PatientResponseDTO createPatient(PatientRequestDTO patientRequestDTO) {
        ...
        // If registeredDate is not provided, set it to current date
        if (patientRequestDTO.getRegisteredDate() == null || patientRequestDTO.getRegisteredDate().isEmpty()) {
            patientRequestDTO.setRegisteredDate(LocalDate.now().toString());
        }
    ...
    public PatientResponseDTO updatePatient(UUID id, PatientRequestDTO patientRequestDTO) {
        ...
        // Update only allowed fields - registeredDate is NOT updated (preserved)
        patient.setName(patientRequestDTO.getName());
        patient.setAddress(patientRequestDTO.getAddress());
        patient.setEmail(patientRequestDTO.getEmail());
        patient.setDateOfBirth(LocalDate.parse(patientRequestDTO.getDateOfBirth()));
        // Note: registeredDate is intentionally NOT updated - it's a historical record
